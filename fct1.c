/*                                                                                                   
** fct1.c for my_printf in /home/bourge_v/rendu/PSU_2013_my_printf                                   
**                                                                                                   
** Made by bourge_v                                                                                  
** Login   <bourge_v@epitech.net>                                                                    
**                                                                                                   
** Started on  Sun Nov 17 23:27:48 2013 bourge_v                                                     
** Last update Sun Nov 17 23:27:49 2013 bourge_v                                                     
*/
...
int     flag_d(va_list list, int output, char *ptr) /* d + i */
{
  int   nb;
